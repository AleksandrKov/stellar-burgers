...
const config = {
  ...
  coverageProvider: 'v8', // Использует движок V8 для покрытия кода
  transform: {
    '^.+\\.tsx?$': [
      'ts-jest',
      {
        tsconfig: 'tsconfig.json', // путь к вашему tsconfig.json
        isolatedModules: true, // ускоряет компиляцию
        diagnostics: true // вывод диагностики TypeScript в терминал
      }
    ]
  },
  moduleNameMapper: {
...
//   // cacheDirectory: "/private/var/folders/sw/4llrjw2s1dldy52k0v6cgf000000gn/T/jest_dx",
